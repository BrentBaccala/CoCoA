...
$$\{2y_tx_{tt} +2y_t +y, x_t^2 +x\} -> x_ty_t +yx_t$$
$$\{x_ty_t +yx_t, x_t^2 +x\} -> -xy_t -xy$$
$$\{-xy_t -xy, x_ty_t +yx_t\} -> -xy_{tt} -xy_t$$
$$\{-xy_{tt} -xy_t, x_ty_t +yx_t\} -> yx_ty_{tt} -x_ty_t^2 -xy_ty_{ttt} -xy_ty_{tt}$$
$$\{yx_ty_{tt} -x_ty_t^2 -xy_ty_{ttt} -xy_ty_{tt}, x_t^2 +x\} -> xyx_ty_{ttt} -xx_ty_ty_{tt} -xyy_{tt} +xy_t^2$$
