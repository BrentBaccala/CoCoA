...
void program()
{
  ...
  vector<symbol> names = symbols("x", "y", "z", "u"); // up to 4
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-RingWeyl3.C,v 1.6 2012/02/08 17:48:04 bigatti Exp $
