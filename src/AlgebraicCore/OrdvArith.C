...
#if CoCoA_THREADSAFE_HACK
    vector<OrdvElem> myOrdvBuffer(myNumIndets); // NB hides data member!
#endif
    myDecompress(myOrdvBuffer, ordv1, myNumIndets);
...
// RCS header/log
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/OrdvArith.C,v 1.38 2014/07/31 13:10:46 bigatti Exp $
// $Log: OrdvArith.C,v $
